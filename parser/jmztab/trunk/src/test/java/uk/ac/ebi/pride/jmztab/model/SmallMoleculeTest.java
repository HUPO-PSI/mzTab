...
public class SmallMoleculeTest extends TestCase {
	public void testMarshallingUnmarshalling() {
		String line1 = "SML\tThe molecule\tPRIDE_1234\tH2O\tnull\tnull\tA molecule that just rocks.\t143.45\t2\t10.0|28.8\t9606\tHuman (Homo sapiens)\tnull\tnull\t2\tnull\tms_file[4]:1\t[,,SpectraST,]\tnull\tnull\tThis col is cool!";
