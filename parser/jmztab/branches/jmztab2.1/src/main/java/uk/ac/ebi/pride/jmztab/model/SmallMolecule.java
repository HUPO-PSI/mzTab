...
public class SmallMolecule extends MZTabRecord {
    ...
    public SplitList<Param> getSearchEngineScore(MsFile msFile) {
        return getSplitList(getPosition(SmallMoleculeColumn.SEARCH_ENGINE_SCORE, msFile));
    }

    public void setSearchEngineScore(MsFile msFile, SplitList<Param> searchEngineScore) {
        setValue(getPosition(SmallMoleculeColumn.SEARCH_ENGINE_SCORE, msFile), searchEngineScore);
    }
