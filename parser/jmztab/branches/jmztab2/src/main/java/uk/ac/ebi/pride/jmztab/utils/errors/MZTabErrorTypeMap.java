...
public class MZTabErrorTypeMap {
    ...
    public MZTabErrorTypeMap() {
        ...
        add(LogicalErrorType.Duplication);
        add(LogicalErrorType.UnitID);
        add(LogicalErrorType.ColUnit);
        ...
        add(LogicalErrorType.Software);
        add(LogicalErrorType.AbundanceColumnId);
