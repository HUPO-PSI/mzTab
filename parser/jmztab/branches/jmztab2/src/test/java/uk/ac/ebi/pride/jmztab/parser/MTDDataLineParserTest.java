...
public class MTDDataLineParserTest {
    ...
    @Test
    public void testProteinData() throws Exception {
        ...
        dataParser.parse(2, data);
    }

    @Test
    public void testPeptideData() throws Exception {
    ...
    @Test
    public void testSmallMoleculeData() throws Exception {
