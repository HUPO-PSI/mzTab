...
public class MTDLineParserTest {
    ...
    public void testUnitParser() throws Exception {
        ...
        parser.check(1, "MTD\tPRIDE_1234-publication\tpubmed:21063943|doi:10.1007/978-1-60761-987-1_6");
        parser.check(1, "MTD\tPRIDE_1234-publication\tpubmed:20615486|doi:10.1016/j.jprot.2010.06.008");
