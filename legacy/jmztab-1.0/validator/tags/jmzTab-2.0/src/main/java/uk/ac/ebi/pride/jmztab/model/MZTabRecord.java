 ...
 * Date: 05/02/13
 */
public abstract class MZTabRecord implements PropertyChangeListener {
    /**
     * Inherit MZTabRecord class can use this MZTabColumnFactory to add optional columns.
    ...
    protected SplitList getSplitList(int position) {
    ...
    protected Reliability getReliability(int position) {
    ...
    protected MZBoolean getMZBoolean(int position) {
