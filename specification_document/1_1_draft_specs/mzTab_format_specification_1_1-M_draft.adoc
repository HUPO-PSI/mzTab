...
image::img/media/figure1.png[image,width=100%]
...
IMPORTANT: TODO
#Insert some text in here about standard numerical encoding, e.g. US default style “x.x”, i.e. using a period for decimal separation and no commas to separate thousands. Joel is investigating#
...
IMPORTANT: TODO
#Ideal encoding is to put these into separate mzTab files - Andy to add this section#
