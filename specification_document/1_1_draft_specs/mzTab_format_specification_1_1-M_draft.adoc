...
// TODO To confirm whether we want document flagged in this way. AJ
...
image:img/media/image2.jpg[image,width=664,height=704]
...
=== Recommendations for reporting quantification results
////
TODO This section needs an update to mention about possibility for multiplexing in metabolomics.
Multiplexing not really done now, so either remove this section or change it to be a section about how to report positive vs negative mode for example. AJ
////
...
=== Adding optional columns
//TODO remove summary / complete references? NH
...
[[metadata-section]]
=== Metadata Section
// TODO Split this section into “Core”, then “Proteomics”, then “Metabolomics” – depending on decision of how to proceed with joint development, AJ
...
[[instrument1-n-name]]
==== instrument[1-n]-name
//TODO Instrument[1-n] makes no sense, since instrument cannot be referenced from ms_run, so even if multiple instruments are reported, they cannot be interpreted. AJ
[cols=",",]
|==========================================================================================================
...
[[software1-n]]
==== software[1-n]
//TODO Update with metabolomics software. AJ
[cols=",",]
|============================================================================================================================================================================================================================
...
[[assay1-n]]
==== assay[1-n]
//TODO We need a section above describing clearly what is an assay. AJ
[cols=",",]
|======================================================================================================================
...
//TODO add additional assay CV params
[cols=",",]
|==================================================================
...
//TODO insert example URI, Need an example to show this working. AJ
[cols=",",]
|====================================================================================================================================
...
//TODO Need section higher up that explains clearly the cardinalities and real world concepts these represent. AJ
[cols=",",]
|===========================================================================================================================================================================================================================================================
|*Description:* |
...
//TODO We are using different separator types across the document, these should be made consistent. AJ
[cols=",",]
|==============================================================================================
...
//TODO Proposed new attribute in 1.1. AJ
//TODO Imputation at assay level? Do we wish to capture this method somehow? AJ
[cols=",",]
|==========================================================================================================================================================================================================================================================================================
...
Provisionally decided to support pre-fractionation by allowing. AJ
////
[cols=",",]
|=====================================================================================================================================================================================================================================================================================================================================================
...
[[ms_run1-n-format]]
==== ms_run[1-n]-format
//TODO Revisit for pre-fractionation. AJ
[cols=",",]
|====================================================================================================================================================================
...
//TODO No need to support pre-fractionation – can reasonably assume all consistent. AJ
[cols=",",]
|==================================================================================================================================================================
...
[[ms_run1-n-hash]]
==== ms_run[1-n]-hash
//TODO Needs to allow for pre-fractionation. AJ
[cols=",",]
|======================================================================================================================================================================================
...
//TODO No need to support pre-fractionation. AJ
[cols=",",]
|=========================================================================================================================================================================================================================================================================
...
[[database1-n-prefix]]
==== database[1-n]-prefix
//TODO Make sure to explain that the colon must followed these prefixes in the SMF section below. AJ
[cols=",",]
|====================================================================================================================================================
...
==== small_molecule-quantification_unit
//TODO Examples to be added from a range of software packages. AJ
[cols=",",]
|=============================================================================================================
...
[[database_identifier]]
==== database_identifier
//TODO May want to return to this for the case of alternative IDs and ambiguity – should this be formally checkable for structure? AJ
//TODO Add example showing ambiguity.
[cols=",",]
|=================================================================================================================================================================================================================================================================================================================================
|*Description:* |
...
[[inchi]]
==== #inchi#
//TODO Inchi throughout not inchi_key to check. AJ
...
[[retention_time]]
==== retention_time
//TODO Possible addition to Metadata section to describe how RT values are reported in this section. AJ
[cols=",",]
|==================================================================================================================================================================================================================================================================================================================================================================================================================================
...
[[adduct_ions]]
==== adduct_ions
//TODO Joel to insert a regex here. AJ
[cols=",",]
|============================================================================================================================================================================================================================================================================================================================================================
...
[[reliability]]
==== reliability
//TODO ACTION: Steffen to circulate MSI list to us for discussion about it going into PSI-MS Cv. AJ
...
|*Example:* a|
....
SMH SML_ID … smallmolecule_abundance_assay[1] …
SML 1 … 0.3 …
....
|=====================================================================================================================================================================
...
|*Example:* a|
....
SMH SML_ID … smallmolecule_abundance_study_variable[1] …
SML 1 … 0.3 …
....
|============================================================================================================================================================================================================================================================================
...
|*Example:* a|
....
SMH SML_ID … smallmolecule_abundance_study_variable[1] smallmolecule_abundance_ coeffvar_study_variable[1]…
SML 1 … 0.3 0.04 …
....
|=========================================================================================================================
...
Do we want to state that only PSI-MS can be used here, or any CV / ontology? AJ
////
[cols=",",]
|===============================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
...
[[adduct_ion]]
==== adduct_ion
//TODO Add URL to these recommendations? AJ
//TODO Joel to write a regex for this. AJ
[cols=",",]
|==========================================================================================================================================================================================================
...
|*Type:* |String List
|*Is Nullable:* |*FALSE* //TODO To add to documentation how to do this for manual curation etc. AJ
|*Example:* a|
....
