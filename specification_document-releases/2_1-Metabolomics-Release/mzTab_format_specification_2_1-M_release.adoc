...
[[use-cases-for-mztab]]
== Requirements for mzTab-M 2.0.0
...
[[updates-for-mztabm-2_1]]
== Updates and Additions for mzTab-M 2.1.0

During the years since the initial release of mzTab-M 2.0.0, some additions and modifications to mzTab-M have become necessary through new or changed requirements. 
