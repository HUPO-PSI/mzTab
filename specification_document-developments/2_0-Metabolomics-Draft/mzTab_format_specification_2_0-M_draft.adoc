...
0 isolated, pure compound, full stereochemistry
1 reference standard match or full 2D structure
2 unambiguous diagnostic evidence (literature, database)
3 most likely structure, including isomers, substance class or substructure match
4 unknown compound
...
2a unambiguous ms library match
2b diagnostic evidence
3 tentative candidates
