...
With commit: {commit-hash} https://github.com/HUPO-PSI/mzTab/commit/{commit-hash}
...
* Andrew R Jones, Institute of Integrative Biology, University of Liverpool, United Kingdom. (Editor)
