...
:pdf-page-size: A4
//use autofit to reduce font size in listing blocks in pdf output to avoid line-breaks.
:autofit-option:
...
* Joel Rein, Wellcome Trust Sanger Institute, Cambridge, United Kingdom.
