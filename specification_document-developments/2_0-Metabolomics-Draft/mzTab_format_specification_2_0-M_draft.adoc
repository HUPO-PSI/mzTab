...
* Sample processing and separation techniques (http://psidev.info/sepcv). We recommend to use the MSIO (see below) as a CV specifically designed for metabolomics, including harvesting, material and sample processing.
