...
The current version of this document is: version 1.1.0-draft, April 2018.
...
[start=2]
. <<use-cases-for-mztab>> lists use cases mzTab-M is designed to support. . <<notational-conventions>> describes the terminology used.
. <<relationships-to-other-specifications>> describes how the specification presented in <<format-specification>> relates to other specifications, both those that it extends and those that it is intended to complement.
...
The following cases of usage have driven the development of the mzTab data model, and are used to define the scope of the format in version 1.1.
...
NOTE: This table shows examples from the CV but will be extended. The CV holds the definite specification for legal encodings of spectrum identifier values.
...
All small molecule identifications reported in an mzTab file MAY be assigned a reliability score (column “reliability” in all tables). This reliability only applies to the identification reliability.
...
[[figure-2]]
image::img/media/figure2.png[image,width=100%,pdfwidth=100%]
...
|*Type:* |Regex{"1\.1\.\d-M"}
|*Mandatory* |True
|*Example:* a|`MTD mzTab-version  1.1.0-M`
|==============================================
...
[cols=",",]
|==========================================================================================================
|*Description:* |Within file unique identifier for a given instrument.
|*Type:* |Parameter
|*Mandatory* |False
|*Example:* a|
....
MTD instrument[1]-id 1
....
|==========================================================================================================
...
|*Example:* a|
....
MTD software[1] [MS, MS:100XXXX, Progenesis QI, 3.0]
....
|============================================================================================================================================================================================================================
...
|*Example:* a|
....
MTD uri[1] https://www.ebi.ac.uk/metabolights/MTBLS517/files/i_Investigation.txt
...
MTD ms_run[1]-scan_polarity[1] [MS, MS:1000130, positive scan, ]
MTD ms_run[1]-scan_polarity[12] [MS, MS:1000129, negative scan, ]
|===========================================================================
...
[[study_variable1-n_average_function1-n]]
==== study_variable[1-n]_average_function
[cols=",",]
|==========================================================================================================================================================================================================================================================================================
|*Description:* |The function used to calculate the study variable quantification value if it is reported and the operation used is not arithmetic mean (default) e.g. “geometric mean”, “median”. The 1-n refers to different study variables.
|*Type:* |Parameter
|*Mandatory* |False
|*Example:* a|
[subs="verbatim,quotes"]
....
#MTD study_variable_average_function [STATO, OBI:0200119, median calculation, ]#
....
|==========================================================================================================================================================================================================================================================================================

[[study_variable1-n_variation_function]]
==== study_variable[1-n]_variation_function
[cols=",",]
|==========================================================================================================================================================================================================================================================================================
...
[subs="verbatim,quotes"]
....
#MTD study_variable_variation_function [STATO, STATO:0000236, coefficient of variation, ]#
....
|==========================================================================================================================================================================================================================================================================================
...
MTD small_molecule-quantification_unit [UO, UO:0000041, nanomole, ]
....
|=============================================================================================================
...
MTD small_molecule_feature-quantification_unit [PSI-MS, MS:1002830, XCMS:intf, ]
....
|=====================================================================================================================
...
[subs="verbatim,quotes"]
....
#MTD small_molecule-identification_reliability [, , Numerical system defined in publication, PMID:XXX]#
....
|================================================================================================================================================
...
|*Example:* a|
....
id_confidence_measure[1]	[MS,MS:1000XXX,Progenesis MetaScope Score,]
id_confidence_measure[2]	[MS,MS:1000XXX,Fragmentation Score,]
id_confidence_measure[3]	[MS,MS:1000XXX,Isotopic fit Score,]
...
....
SMH SML_ID … uri …
SML 1 … http://www.hmdb.ca/metabolites/HMDB0001847 …
SML 2 … http://identifiers.org/hmdb/HMDB0001847 …
....
|================================================================================================================================================================================================================================================================================================================================================================================
...
[cols=",",]
|============================================================================================================================================================================================================================================================================
|*Description:* |The small molecule’s abundance in all the study variables described in the Metadata section (study_variable[1-n]_average_function), calculated using the method as described in the Metadata section (default = arithmetic mean across assays). Null or zero values may be reported as appropriate.
|*Type:* |Double
|*Is Nullable:* |*TRUE*
|*Example:* a|
....
...
[cols=",",]
|===========================================
|*Description:* |The feature’s charge value using "-1" or "1" for negative or positive mode.
|*Type:* |Integer
|*Is Nullable:* |*FALSE*
|*Example:* a|
....
...
SME 1 ms_run[1]:index=274
SME 2 ms_run[2]:index=287
SME 3 ms_run[3]:index=365
....
...
IMPORTANT: Please add affiliations#
