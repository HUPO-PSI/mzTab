 ...
 *         All of them have been defined in {@link ProteinColumn}, {@link PeptideColumn}, {@link PSMColumn} and {@link SmallMoleculeColumn}.
 *     </li>
 *     <li>
 *         Optional column with stable order: column name, data type and order have defined in the {@link ProteinColumn}, {@link PeptideColumn},
 *         {@link PSMColumn} and {@link SmallMoleculeColumn}. But header name, logical position dynamically depend on {@link IndexedElement}.
 *         These optional column generated by {@link #addOptionalColumn(MZTabColumn, MsRun)} method.
 *     </li>
 *     <li>
 *         Optional columns which put the end of table-based section. There are three types of optional column:
 *         {@link AbundanceColumn}, {@link OptionColumn} and {@link CVParamOptionColumn}, which always be added at the end of table.
 *         These optional columns have not stable column name, data type or order. In this factory, we use {@link #addAbundanceOptionalColumn(Assay)}
 *         to generate {@link AbundanceColumn}; use {@link #addOptionalColumn(String, Class)} to create {@link OptionColumn}; and
...
public class MZTabColumnFactory {
     ...
     * The header like: {Section}_abundance_study_variable[1], {Section}_abundance_stdev_study_variable[1], {Section}_abundance_std_error_study_variable[1].
     *
