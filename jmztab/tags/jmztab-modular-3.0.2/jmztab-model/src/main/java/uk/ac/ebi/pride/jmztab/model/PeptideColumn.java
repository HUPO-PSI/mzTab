...
public class PeptideColumn extends MZTabColumn {
    ...
    PeptideColumn(String name, Class columnType, boolean optional, String order, Integer id) {
    ...
    public static PeptideColumn BEST_SEARCH_ENGINE_SCORE = new PeptideColumn("best_search_engine_score", Double.class, true, "07");
    public static PeptideColumn SEARCH_ENGINE_SCORE = new PeptideColumn("search_engine_score", Double.class, true, "08");
