...
import static uk.ac.ebi.pride.jmztab.converter.utils.FileFormat.PRIDE;
 ...
 * @since 26/03/13
 */
public class MZTabGraphicalInterface extends JFrame {
    ...
    public static void main(String[] args) {
        Runnable runner = new Runnable() {
            public void run() {
                try {
                    MZTabGraphicalInterface inspector = new MZTabGraphicalInterface();
    ...
    public MZTabGraphicalInterface() {
                ...
                SwingWorker worker = new SwingWorker<Void, Void>() {
                    ...
                    protected Void doInBackground() throws Exception {
                        ...
                        if (fileName == null || fileName.trim().length() == 0) {
                            JOptionPane.showMessageDialog(MZTabGraphicalInterface.this, "Please choose a MZTabFile!");
                            return null;
                        }
            ...
            public void mousePressed(MouseEvent e) {
                SwingWorker worker = new SwingWorker<Void, Void>() {
                    ...
                    protected Void doInBackground() throws Exception {
                        ...
                        if (fileName == null || fileName.trim().length() == 0) {
                            JOptionPane.showMessageDialog(MZTabGraphicalInterface.this, "Please choose a file!");
                            return null;
                        }

                        String outDirName = tarFileDirField.getText();
                        if (outDirName == null || outDirName.trim().length() == 0) {
                            JOptionPane.showMessageDialog(MZTabGraphicalInterface.this, "Please choose a target directory!");
                            return null;
                        }
                        ...
                        FileFormat format = PRIDE;
                        while (elements.hasMoreElements()) {
                            element = elements.nextElement();
                            if (element.isSelected()) {
                                format = getFormat(element.getText());
                                break;
                            }
                        }
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(MZTabGraphicalInterface.this, "There exists errors during read file process.");
                            return null;
                        }
